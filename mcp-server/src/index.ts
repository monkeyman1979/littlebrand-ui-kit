  ...
  async (params) => {
    try {
      ...
      if (params.response_format === ResponseFormat.MARKDOWN) {
        ...
        // Group by category
        const byCategory = new Map<string, typeof filteredComponents>();
  ...
  async (params) => {
    try {
      ...
      if (params.response_format === ResponseFormat.MARKDOWN) {
        ...
        // Group by category
        const byCategory = new Map<string, typeof limitedTokens>();
